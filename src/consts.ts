...
export const SITE_DESCRIPTION =
  'SRKR Engineering College, Bhimavaram — NAAC A+ accredited autonomous institution (Est. 1980) offering NBA-accredited B.Tech, M.Tech programs in CSE, ECE, EEE, Civil, Mechanical, IT, AI/ML, AI/DS and emerging tech. Top placements, world-class labs, premier engineering education in Andhra Pradesh.';
